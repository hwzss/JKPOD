...
extern const NSString* INTERFACE_FAILED;
...
extern const NSString* JK_APP_ID;
extern const NSString* JK_App_Secret;
extern const NSString* JK_APP_Url;
extern const int JK_APP_Port;
