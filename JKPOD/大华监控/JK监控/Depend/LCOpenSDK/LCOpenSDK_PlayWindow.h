 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspPlaybackByFileName:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk fileName:(NSString*)fileName;
/**
 *  按开始/结束时间回放设备本地录像
 *
 *  @param accessTok 管理员token/用户token
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playCloud:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk recordID:(int64_t)recordID Type:(NSInteger)type timeOut:(NSInteger)timeOut;
/**
 *  停止云录像播放
 *
 *  @return 0, 接口调用成功
